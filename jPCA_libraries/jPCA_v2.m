...
% 
% 
function [Projection, Summary,bigA] = jPCA_v2(Data, analyzeTimes, params)
...
function Vr = getRealVs(V,evals)
    ...
    rotV = pca(testProj);  %changed by Kevin 
